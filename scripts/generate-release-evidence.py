...
def main() -> int:
    ...
    md = [
        ...
        f"- Trivy status: `{evidence['trivy_status'] or 'not recorded'}`",
        f"- Trivy release gate: `{evidence['trivy_gate'] or 'not recorded'}`",
        f"- Trivy severity gate: `{evidence['trivy_severity'] or 'not recorded'}`",
        f"- Trivy report: {evidence['trivy_report'] or 'not recorded'}",
